...
const Chatbot = () => {
  ...
  const handleSendMessage = async () => {
    ...
    const prompt = input;
    const prompttext = " For the above question, first introduce yourself as Yaska Event Hub AI for every chat and give the response in about 5 points for every question. And give a bonus information on corporate event management.";
